              ...
              <div className="px-6 bg-white    w-[990px]  h-[600px] flex  flex-col">
                ...
                <Tabs
                  tabs={[
                    {
                      label: "Dashboard",
                      content: <TabDashboard loanUid={loan.LUid} hash={loan.TxId}  />,
                    },
                    {
                      label: "Transaction History",
                      content: <TabTransaction loanUid={loan.LUid}/>,
                    },
                    {
                      label: "Traceability of Assets",
                      content: <TabTraceability loanUid={loan.ID}/>,
                    },
                    { label: "Documents", content: <TabDocuments account={loan.ID} /> },
                    {
